...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_ws_key_16867b9bc589814e = function(arg0) {
        const ret = ws_key();
        const ptr1 = passStringToWasm0(ret, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        getDataViewMemory0().setInt32(arg0 + 4 * 1, len1, true);
    ...
    imports.wbg.__wbindgen_cast_6aa25f12997b26f0 = function(arg0, arg1) {
        // Cast intrinsic for `Closure(Closure { dtor_idx: 6, function: Function { arguments: [], shim_idx: 244, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
...
export const info = { version: "2.1.19-1", minimal: 0===1, release: 1===1, commit: "93d5a726894b2f16bad54c4a3801446cbbd22d26" };
